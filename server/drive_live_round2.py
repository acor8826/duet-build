"""Round 2 of live GPT-5.5 critique: rescore the revised candidate that
addresses GPT-5.5's prior C1-C3 critique items.
"""
...
from drive_live_demo import drive_turn, SPEC  # noqa: E402

REVISED = Path(r"C:\Users\acor8\.claude\duet\sessions\job-c33926d97c-candidate-final.txt").read_text(encoding="utf-8").strip()
...
def main() -> int:
    ...
    print("=== CRITIC TURN ROUND 2 (gpt-5.5 on revised candidate) ===")
