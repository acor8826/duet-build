"""Round 7 — with explicit AustLII URL inline."""
...
REVISED = Path(r"C:\Users\acor8\.claude\duet\sessions\job-c33926d97c-candidate-r7.txt").read_text(encoding="utf-8").strip()
