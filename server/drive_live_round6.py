"""Round 6 — maximally tight candidate."""
...
REVISED = Path(r"C:\Users\acor8\.claude\duet\sessions\job-c33926d97c-candidate-r6.txt").read_text(encoding="utf-8").strip()
