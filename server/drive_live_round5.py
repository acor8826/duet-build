"""Round 5: candidate = gpt-5.5's own r4 counter-draft."""
...
REVISED = Path(r"C:\Users\acor8\.claude\duet\sessions\job-c33926d97c-candidate-r5.txt").read_text(encoding="utf-8").strip()
