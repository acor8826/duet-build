"""Round 3 of live GPT-5.5 critique."""
...
REVISED = Path(r"C:\Users\acor8\.claude\duet\sessions\job-c33926d97c-candidate-r3.txt").read_text(encoding="utf-8").strip()
